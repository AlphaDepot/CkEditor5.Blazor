        ...
        private static CkEditorConfiguration GetDefaultConfiguration()
        {
            var configuration = new CkEditorConfiguration
            {
                ...
                ["htmlSupport"] = new
                {
                    allow = new[]
                    {
                        new { name = "^.*$", styles = true, attributes = true, classes = true }
                    }
                },
                ["image"] = new
                {
                ...
                ["list"] = new
                {
                    properties = new { styles = true, startIndex = true, reversed = true }
                },
                ["placeholder"] = "Type or paste your content here!",
                ["style"] = new
                {
                ...
                ["table"] = new
                {
                    contentToolbar = new[] { "tableColumn", "tableRow", "mergeTableCells", "tableProperties", "tableCellProperties" }
                },
                ["updateSourceElementOnDestroy"] = true
            };
